...
void DIO_voidSetPortD(union_reg_t* Copy_ptr_to_union){
	Copy_ptr_to_union = PORTD;
}

void DIO_voidSetPortB(union_reg_t* Copy_ptr_to_union){
	Copy_ptr_to_union = PORTB;
}

void DIO_voidSetPortC(union_reg_t* Copy_ptr_to_union){
	Copy_ptr_to_union = PORTC;
}
